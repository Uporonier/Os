...
public class UserController {
    ...
    @PostMapping("/login")
    public Result login(HttpServletResponse httpServletResponse, HttpServletRequest httpServletRequest, @RequestBody LoginForm loginForm) {
        UserDTO dto = userService.login(httpServletResponse,httpServletRequest,loginForm);
