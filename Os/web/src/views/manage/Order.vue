<template>
  <div>
    ...
    <el-table :data="tableData" border stripe style="width: 100%">
      ...
      <el-table-column prop="userId" label="下单人id" width="80"></el-table-column>
      <el-table-column prop="goodsid" label="商品id" width="70"></el-table-column>
      <el-table-column prop="linkUser" label="联系人" width="70"></el-table-column>
      <el-table-column prop="linkPhone" label="联系电话" width="100"></el-table-column>
      <el-table-column prop="linkAddress" label="送货地址" width="100"></el-table-column>
      <el-table-column prop="state" label="状态" width="100">
        <template slot-scope="scope" width="50">
          ...
          <el-tag type="success" v-if="scope.row.state==='已收货'">{{scope.row.state}}</el-tag>
          <el-tag type="info" v-if="scope.row.state==='已失效'">{{scope.row.state}}</el-tag>
          <el-tag type="warning" v-if="scope.row.state==='待付款'">{{scope.row.state}}</el-tag>
        </template>
      </el-table-column>
      <el-table-column prop="createTime" label="下单时间" width="250"></el-table-column>
      <el-table-column
          fixed="right"
          label="操作"
          width="150">
...
<!--          </el-button>-->
          ...
          <el-popconfirm
              v-if="scope.row.state==='已失效'"
          >
            <el-button type="error" style="font-size: 15px;margin-left: 10px;" slot="reference" disabled="">
              <i class="el-icon-a-07"></i>
              订单失效
            </el-button>
          </el-popconfirm>
          ...
          >
            <el-button type="warning" style="font-size: 15px;margin-left: 10px;" slot="reference" disabled="">
              <i class="el-icon-a-07"></i>
              等待支付
            </el-button>
          </el-popconfirm>
          ...
          >
            <el-button type="primary" style="font-size: 15px;margin-left: 10px;" slot="reference" disabled="">
              <i class="el-icon-a-07"></i>
              等待签收
            </el-button>
          </el-popconfirm>
          <el-popconfirm
              v-if="scope.row.state==='已收货'"
          >
            <el-button type="success" style="font-size: 15px;margin-left: 10px;" slot="reference" disabled="">
              <i class="el-icon-a-07"></i>
              交易完成
            </el-button>
          </el-popconfirm>
