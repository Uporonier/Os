...
const routes = [
    //前台
  {
    ...
    children: [
      ...
      {path: 'recommend', name: 'recommend', meta: {title:'猜你喜欢',requireLogin: true}, component: () => import('../views/front/recommend/Recommend.vue'),},
      ...
      {path: 'preOrder1', name: 'preOrder1', meta: {title:'确认订单',requireLogin: true}, component: () => import('../views/front/order/PreOrder1.vue'),},
...
//秒杀商品模块
//       {path: 'secKill', name: 'secKill', meta: {title:'秒杀活动'}, component: () => import('../views/front/secKill.vue'),},
